...
SIGNAL \inst1|pll_inst|altera_pll_i|general[0].gpll~PLL_RECONFIGSHIFTEN5\ : std_logic;
...
\inst1|pll_inst|altera_pll_i|general[0].gpll~PLL_RECONFIGSHIFTEN5\ <= \inst1|pll_inst|altera_pll_i|general[0].gpll~PLL_RECONFIG_SHIFTEN_bus\(5);
...
PORT MAP (
	...
	shiften => \inst1|pll_inst|altera_pll_i|general[0].gpll~PLL_RECONFIGSHIFTEN5\,
...
-- pragma translate_on
PORT MAP (
	datab => \inst|ALT_INV_counter_out\(1),
...
-- pragma translate_on
PORT MAP (
	dataa => \inst|ALT_INV_counter_out\(8),
	cin => \inst|Add0~78\,
...
-- pragma translate_on
PORT MAP (
	datab => \inst|ALT_INV_counter_out\(13),
	cin => \inst|Add0~58\,
...
-- Equation(s):
-- \inst2|LPM_MUX_component|auto_generated|l1_w3_n0_mux_dataout~0_combout\ = (!\KEY[0]~input_o\ & (\inst|counter_out\(24))) # (\KEY[0]~input_o\ & ((\inst|counter_out\(26))))
...
PORT MAP (
	...
	datab => \inst|ALT_INV_counter_out\(24),
...
-- Equation(s):
-- \inst2|LPM_MUX_component|auto_generated|l1_w2_n0_mux_dataout~0_combout\ = (!\KEY[0]~input_o\ & (\inst|counter_out\(23))) # (\KEY[0]~input_o\ & ((\inst|counter_out\(25))))
...
PORT MAP (
	...
	datac => \inst|ALT_INV_counter_out\(25),
...
-- Equation(s):
-- \inst2|LPM_MUX_component|auto_generated|l1_w1_n0_mux_dataout~0_combout\ = ( \inst|counter_out\(22) & ( (!\KEY[0]~input_o\) # (\inst|counter_out\(24)) ) ) # ( !\inst|counter_out\(22) & ( (\inst|counter_out\(24) & \KEY[0]~input_o\) ) )
